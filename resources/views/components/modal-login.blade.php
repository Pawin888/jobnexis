<div x-data="{ show: {{ session('showLoginModal') ? 'true' : 'false' }} }" x-show="show" x-cloak
    class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
    <div @click.away="show = false" class="relative w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
        <button @click="show = false" class="absolute text-gray-400 top-2 right-2 hover:text-black">
            &times;
        </button>
